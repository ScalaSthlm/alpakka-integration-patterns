...
/**
  * To start a web server be sure to include this dependency:
  *
    ...
    pathSingleSlash {
      complete {
        ...
        HttpEntity(ContentTypes.`text/html(UTF-8)`,
          "<html><body>Welcome to the playground!</body></html>")
      }
    } ~
      path("hello") {
        get { ctx =>
...
//        }
  ...
  override protected def waitForShutdownSignal(system: ActorSystem)(
    implicit ec: ExecutionContext): Future[Done] = shutdownPromise.future
